...
if __name__ == '__main__':
    ...
    for threshold in [0.2, 0.4, 0.5]:
        filename = "_".join([args.conv_type, args.activation, args.loss_type, args.dataset, args.process, str(threshold), str(args.epochs)])
        log_file = "log_"+ filename
        image_file_folder = "../Failed_" + filename
        os.mkdir(image_file_folder)

        seg = Segmentation(args.process, args.bs, args.epochs, tuple(args.resolution), args.activation, args.loss_type, threshold, args.conv_type)
